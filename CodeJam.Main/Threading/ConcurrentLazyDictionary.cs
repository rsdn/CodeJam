...
namespace CodeJam.Threading
{
	...
	public class ConcurrentLazyDictionary<TKey, TValue> : ILazyDictionary<TKey, TValue> where TKey : notnull
	{
		...
		/// <param name="valueFactory">Function to create value on demand.</param>
		/// <param name="comparer">Key comparer.</param>
		public ConcurrentLazyDictionary([JetBrains.Annotations.NotNull] Func<TKey, TValue> valueFactory, [CanBeNull] IEqualityComparer<TKey>? comparer)
		{
			Code.NotNull(valueFactory, nameof(valueFactory));
		...
		/// </summary>
		/// <param name="valueFactory">Function to create value on demand.</param>
		public ConcurrentLazyDictionary([JetBrains.Annotations.NotNull] Func<TKey, TValue> valueFactory)
		...
		/// <exception cref="T:System.ArgumentNullException">
		/// <paramref name="key" /> is null.</exception>
		public bool TryGetValue(TKey key, [NotNullWhen(true)] out TValue? value) => _map.TryGetValue(key, out value);
		...
		public TValue this[[JetBrains.Annotations.NotNull] TKey key] => _map.GetOrAdd(key, _valueFactory);
