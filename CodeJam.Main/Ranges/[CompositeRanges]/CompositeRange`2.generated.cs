...
namespace CodeJam.Ranges
{
	...
	public partial struct CompositeRange<T, TKey> : IEquatable<CompositeRange<T, TKey>>, IFormattable
	{
		...
		public static bool operator ==(CompositeRange<T, TKey> range1, CompositeRange<T, TKey> range2) =>
		...
		#region Helpers
		private static bool IsContinuationFor(RangeBoundaryTo<T> lastBoundary, Range<T, TKey> nextRange)
		{
		...
		public CompositeRange(Range<T, TKey> range)
		{
