...
{
	/// <summary>
	/// <see cref="IClock"/> implementation over QueryProcessCycleTime().
	...
	public sealed class ProcessCycleTimeClock : IClock
	{
		...
		static ProcessCycleTimeClock() =>
			_isAvailable = CycleClockHelpers.TryEstimateProcessCycleTimeFrequency(
		...
		public string Title => "CPU cycles (Process)";
		...
		public long GetTimestamp() => CycleClockHelpers.GetCurrentProcessTimestamp();
