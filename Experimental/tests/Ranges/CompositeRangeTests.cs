...
namespace CodeJam.Ranges
{
	...
	public static class CompositeRangeTests
	{
		...
		public static void TestRangeProperties()
		{
			...
			AreEqual(a, CompositeRange.Create(Range<int>.Empty, Range<int>.Empty));
			...
			a = new CompositeRange<int>(Range<int>.Infinite);
			AreNotEqual(a, CompositeRange<int>.Empty);
			AreEqual(a, CompositeRange<int>.Infinite);
			AreNotEqual(a, CompositeRange.Create(Range<int>.Infinite, Range<int>.Infinite));
			AreEqual(a.SubRanges.Count, 1);
			AreEqual(a.ContainingRange, Range<int>.Infinite);
			AreEqual(a.SubRanges[0], Range<int>.Infinite);
			IsFalse(a.IsEmpty);
			IsTrue(a.IsNotEmpty);
			IsTrue(a.IsMerged);
		...
		public static void TestKeyedRangeProperties()
		{
			...
			var infiniteXRange = Range<int>.Infinite.WithKey("X");
...
/*
			...
			a = new CompositeRange<int,string>(infiniteXRange);
			AreNotEqual(a, CompositeRange<int>.Empty);
			AreEqual(a, infiniteXRange);
			AreNotEqual(a, CompositeRange.Create(Range<int>.Infinite, Range<int>.Infinite));
			AreEqual(a.SubRanges.Count, 1);
			AreEqual(a.ContainingRange, Range<int>.Infinite);
			AreEqual(a.SubRanges[0], Range<int>.Infinite);
		...
		[Test]
		public static void TestCompositeRangEqualsWithKeys()
		{
			var ranges = new[]
			{
				Range.Create(0, 1, "X"),
