...
namespace CodeJam.DesignDecisions.EmitOrExpressions
{
	...
	public class DecisionMappingPerfTest
	{
		...
		[CompetitionBenchmark(0.82, 0.90), GcAllocations(0)]
		...
		[CompetitionBenchmark(0.76, 0.87), GcAllocations(0)]
		...
		[CompetitionBenchmark(2.78, 3.01), GcAllocations(0)]
		...
		[CompetitionBenchmark(2.86, 3.63), GcAllocations(0)]
		...
		[CompetitionBenchmark(1.15, 1.31), GcAllocations(0)]
		...
		[CompetitionBenchmark(1.16, 1.26), GcAllocations(0)]
		...
		[CompetitionBenchmark(1.14, 1.27), GcAllocations(0)]
