...
namespace CodeJam.Collections
{
	...
	public static partial class EnumerableExtensions
	{
		...
		[NotNull, Pure]
		public static StringBuilder ToDiagnosticString<T>([NotNull] this IEnumerable<T> source, [NotNull] StringBuilder stringBuilder)
		{
			Code.NotNull(source, nameof(source));
			Code.NotNull(source, nameof(stringBuilder));
		...
		/// <returns>Detailed exception text.</returns>
		[NotNull, Pure]
		public static string ToDiagnosticString<T>([NotNull] this IEnumerable<T> source)
		{
			Code.NotNull(source, nameof(source));
