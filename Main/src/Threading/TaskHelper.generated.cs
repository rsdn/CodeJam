...
namespace CodeJam.Threading
{
	partial class TaskHelper
	{
		...
		/// <c>false</c>.
		/// </returns>
		public static bool WaitAll(this Task[] tasks, int timeout) =>
		...
		[NotNull]
		[ItemNotNull]
		public static Task<TResult[]> WhenAll<TResult>(this Task<TResult>[] tasks) => Task.WhenAll(tasks);
		#endregion
		...
		[NotNull]
		[ItemNotNull]
		public static Task<Task<TResult>> WhenAny<TResult>(this Task<TResult>[] tasks) => Task.WhenAny(tasks);
