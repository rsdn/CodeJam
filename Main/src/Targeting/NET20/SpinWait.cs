	...
	public struct SpinWait
	{
		...
		internal void SpinOnce(int sleep1Threshold)
		{
			...
			else
			{
				...
				// BASEDON: https://github.com/dotnet/coreclr/blob/030a3ea9b8dbeae89c90d34441d4d9a1cf4a7de6/src/vm/yieldprocessornormalized.cpp
				int n = 7;
